...
*[gin framework: 'go get github.com/gin-gonic/gin'](https://github.com/gin-gonic/gin)   
*[go gorm: 'go get -u github.com/jinzhu/gorm'](http://jinzhu.me/gorm/)  
*[gin-jwt: go get github.com/appleboy/gin-jwt](https://github.com/appleboy/gin-jwt)     
*[bcrypt:  go get golang.org/x/crypto/bcrypt](https://godoc.org/golang.org/x/crypto/bcrypt)       
*[yaml: go get gopkg.in/yaml.v2](http://gopkg.in/yaml.v2)   
*[endless: go get github.com/fvbock/endless](https://github.com/fvbock/endless)
### Configuration
